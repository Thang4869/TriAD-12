...
describe("ProductsRenderer", () => {
  ...
  describe("UI updates", () => {
    ...
    it("should return default state when sortSelect and priceSlider are missing", () => {
    ...
    it("should fallback to default sort when sort value is empty", () => {
      renderer.sortSelect = {
        value: "",
      };
    ...
    it("should fallback to default maxPrice when price value is empty", () => {
      renderer.priceSlider = {
        value: "",
      };

      const state = renderer.getUIState();

      expect(state.maxPrice).toBe(350000);
    });
  });
  ...
  describe("renderSuggestions", () => {
    ...
    it("should hide suggestions when keyword is null", () => {
      const container = document.getElementById("search-suggestion");

      container.classList.remove("hidden");
      container.innerHTML = "<div>fake</div>";
    ...
    it("should hide suggestions when keyword is undefined", () => {
      const container = document.getElementById("search-suggestion");
