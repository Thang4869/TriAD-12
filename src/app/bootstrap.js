...
export async function bootstrap() {
  ...
  try {
    ...
    setTimeout(() => { notificationController.reinit(); }, 100);
    ...
    const productsService = new ProductsService(productsRepository, container.get('eventBus'));
    const productsRenderer = new ProductsRenderer();
    const productsController = new ProductsController(productsService, productsRenderer, container.get('eventBus'));
